...
<head>
	...
	<title>GARAGE V. PARROT | COMMENTAIRES</title>
</head>
<body>
	<div id="main">
		<header>
		...
		<section class="formulaire">
			...
			<form>
				<input type="text" name="" placeholder="Nom complet" required><br>
				<input type="text" name="" placeholder="Adresse mail" required><br>
				<input type="text" name="" placeholder="Téléphone" required><br>
				<textarea name="" placeholder="Laissez-nous un mot" cols="49">
				</textarea><br>
