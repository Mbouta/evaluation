...
<body>
	<div id="main">
		...
		<section class="formulaire">
			...
			<form action="../admin/app/traitement/visiteur/create.php" method="POST">
				<input type="text" name="nom" placeholder="Nom complet" required><br>
				<input type="text" name="prenom" placeholder="Adresse mail" required><br>
		...
		<div id="commentaire">
			...
			<p><a href="#">Voir tous les avis clients v-parrot.com</a><span>&nbsp;></span></p>
		</div>
		<footer>
