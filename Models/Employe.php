...
class Employe extends Utilisateur implements Voiture, Temoignage
{
     ...
     * 500 BAD
     */
    public function createVoiture($data): int
    {
     ...
     * 500 BAD
     */
    public function createVoitureImages($data): int
    {
     ...
     * 500 BAD
     */
    public function updateVoiture($data, $condition): int
    {
     ...
     * 500 BAD
     */
    public function deleteVoiture($condition): int
    {
    ...
    public function selectAllContact(): bool|array
    {
        $crud = new Crud();
    ...
    public function selectAllTemoignage(): bool|array
    {
        // TODO: Implement selectAll() method.
        $crud = new Crud();
     ...
     * @return int
     */
    public function updateTemoignage($data, $condition): int
    {
        $crud = new Crud();
    ...
    public function deleteTemoignage($condition): int
    {
        $crud = new Crud();
