...
<body>
	<div id="main">
		...
		<section class="galerie">
			<div class="one">
				<img src="assets/img/img.jpg" width="200" height="200">
				<h4>Hello</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do.</p>
				<a href="#" class="first">Commander</a>
				<a href="#" class="second">Contacter</a>
			</div>
			<div class="two">
				<img src="assets/img/2.jpg" width="70" height="70">
				<h4>Hello</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do.</p>
			</div>
			<div class="three">
				<img src="assets/img/3.jpg" width="70" height="70">
				<h4>Hello</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do.</p>
			</div>
		</section>
		<section id="services-d">
			<div class="four">
				<img src="assets/img/4.jpg" width="70" height="70">
				<h4>Hello</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do.</p>
			</div>
			<div class="five">
				<img src="assets/img/5.jpg" width="70" height="70">
				<h4>Hello</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do.</p>
			</div><div class="six">
				<img src="assets/img/6.jpg" width="70" height="70">
				<h4>Hello</h4>
				<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do.</p>
			</div>
		</section>
